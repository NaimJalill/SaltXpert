const chanceCard = [
  ...
  },
  {
    id: 1,
    text: "Congratulations! You've won a chemical innovation competition.",
    note: "You get RM5 from a lab assistant.",
    save: false,
    move: 0,
    cash: 10,
    use: null,
  ...
  {
    id: 3,
    text: "You successfully completed the experiment.",
    note: "Move 2 sites forward.",
    save: false,
    move: 2,
    cash: 0,
    use: null,
  ...
  {
    id: 4,
    text: "You have been selected to participate in a chemical exhibition.",
    note: "You get RM5 from a lab assistant.",
    save: false,
    move: 0,
    cash: 5,
  ...
  {
    id: 5,
    text: "You got a scholarship to study abroad.",
    note: "Move 3 sites forward.",
    save: false,
    move: 3,
    cash: 0,
    use: null,
...
const penaltyCard = [
  ...
  {
    id: 6,
    text: "You are given a warning for not wearing safety goggles during the experiment.",
    note: "Please pay a fine of RM5 to the laboratory assistant.",
    save: false,
    move: 0,
    cash: -5,
